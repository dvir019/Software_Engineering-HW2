...
import static util.Token.Type.TOKEN;
 ...
 */
public final class CSVParser implements Iterable<util.CSVRecord>, Closeable {
    ...
    private Map<String, Integer> createEmptyHeaderMap() {
        return (Map<String, Integer>) (this.format.getIgnoreHeaderCase() ?
